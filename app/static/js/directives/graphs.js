...
app.controller('ContextMenu', [
  '$scope',
  function ($scope) {
      $scope.menuOptions = [
          {
            html:  function($trScope) {
                return "<div style='padding-left:20px;margin-top: -5px;background-color:rgb(158, 218, 229);'><span style='align-content: center'><strong>"+ $trScope.row.symbol +"</strong></span></div>" ;
            },
...
app.directive('contextMenu', ["$parse", "$q", "$sce", function ($parse, $q, custom, $sce) {
